...
export function CashClosingBanner({ branchName, onCloseCash, isLoading }: CashClosingBannerProps) {
    ...
    return (
        <div className="relative group overflow-hidden rounded-2xl bg-rose-50 shadow-sm border border-rose-100/50">
            {/* Subtle highlight */}
            ...
            <div className="relative px-6 py-3 flex flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="w-9 h-9 rounded-lg bg-rose-100 flex items-center justify-center shrink-0">
                        <Info className="w-4.5 h-4.5 text-rose-600" />
                    </div>

                    {/* Text Content - Horizontal & Inline */}
                    <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-3">
                        <h2 className="text-[13px] font-black text-rose-900 uppercase tracking-tight leading-none">
                            Turno Activo en {branchName || 'Sucursal'}
                        </h2>
                        <div className="hidden md:block w-1 h-1 rounded-full bg-rose-300" />
                        <p className="text-rose-700/70 text-[10px] font-bold uppercase tracking-wider">
