        ...
        <form id="product-edit-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4 animate-in slide-in-from-left-4 fade-in duration-300">
              ...
              {/* Category */}
              <div className="space-y-2">
                <Label htmlFor="edit-categoryId" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Categoría</Label>
              ...
              {/* SKU */}
              <div className="space-y-2">
                <Label htmlFor="edit-sku" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">SKU / Código</Label>
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className="h-10 w-10 shrink-0 border-border bg-muted/30 hover:bg-muted text-muted-foreground transition-all active:scale-95"
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="edit-stock" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Stock</Label>
                  <div className="relative">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-minStock" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Stock Mínimo</Label>
                  <div className="relative">
                    <Bell className="absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground/50" />
                    <Input
                      id="edit-minStock"
                      type="number"
                      className="pl-9 bg-muted/30 border-border h-10 text-xs focus:bg-background transition-colors"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="edit-priceCost" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Precio Costo</Label>
                  <div className="relative">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-price" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Precio Venta</Label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-xs font-bold text-muted-foreground/50">
                      {society?.mainCurrency?.symbol || 'S/'}
                    </span>
              ...
              <div className="flex items-center justify-between border-t border-border pt-6">
                <div>
                  <Label htmlFor="edit-isActive" className="text-[10px] font-bold text-foreground uppercase tracking-wider">Estado del Producto</Label>
            ...
            <TabsContent value="attributes" className="space-y-4 animate-in slide-in-from-right-4 fade-in duration-300">
              ...
              {/* Barcode */}
              <div className="space-y-2">
                <Label htmlFor="edit-barcode" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Código de Barras (EAN/UPC)</Label>
                <div className="relative">
              ...
              {/* Brand */}
              <div className="space-y-2">
                <Label htmlFor="edit-brand" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Marca del Producto</Label>
                <div className="relative">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="edit-color" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Color</Label>
                  <div className="relative">
                    <div className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/50">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-colorCode" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Código Hex / Color</Label>
              ...
              <div className="space-y-2 pt-2">
                <Label htmlFor="edit-description" className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Descripción (Opcional)</Label>
                <Textarea
                  id="edit-description"
